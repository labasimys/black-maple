...
<body>
	<div align="center"> 
		<div>
			<img src="images/purchaseList.png" class="buy_title">
			<br><br><br><br>
			...
			<table style="border-collapse: collapse;">
				...
				<%
					...
					ArrayList<Order> list = orderDAO.getList((String)session.getAttribute("userID"));
					for(int i = 0;i<list.size();i++){
				%>
					<td rowspan="2" style="padding-left:20px; padding-top:25px;width:150px; text-align:center;">
						<a href="view.jsp?productID=<%= list.get(i).getProductID() %>"><img src="images/<%= list.get(i).getOrderImg() %>.jpg"style="width:110px; height:110px;"></a>
					</td>
					<td rowspan="2" style="padding-top:25px; width:400px;">
						<a href="view.jsp?productID=<%= list.get(i).getProductID() %>"><%= list.get(i).getOrderName() %></a>
					</td>
					...
					<td rowspan="2" class="cancelbutton" style="padding-left:10px;width:150px; padding-top:20px;">
						<a href="cancelPurchase.jsp?orderID=<%= list.get(i).getOrderID() %>"><button>구매 취소</button></a>
					</td>
				</tr>
				<tr></tr>
				<tr>
